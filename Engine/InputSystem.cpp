...
#include <Windows.h>
InputSystem* InputSystem::m_is = nullptr;
...
{
	if (InputSystem::m_is) throw exception("Input system already created");
	InputSystem::m_is = new InputSystem();
}

void InputSystem::release()
{
	if (!InputSystem::m_is) return;
	delete InputSystem::m_is;
}
